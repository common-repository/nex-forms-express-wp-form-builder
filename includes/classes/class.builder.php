		...
		public function builder7_top_menu(){
				...
				$output .= '<div class="nav-content prime-menu">';
						...
						$output.= '<div class="top-menu-dropdown"><ul class="tabs_nf sec-menu aa_menu"> 
										...
										'.((!get_option('nf_activated') || $theme->Name=='NEX-Forms Demo') ? '<li><a href="https://1.envato.market/6vWmb" target="_blank" class="btn waves-effect-nf waves-light-nf upgrade_pro">BUY NEX-FORMS</a>' : '').'</li>
									  </ul>
									  </div>
	...
	/*** Animation Selection ***/	
		...
		//6 Columns								
																...
																switch($attr['type'])
																	...
																	case 'digital-signature':
																		if ( function_exists('enqueue_nf_digital_sigs_scripts'))
																			...
																			{
																			$output .= '<div class="'.$input_width.'  input_container">';
																					$output .= '<div class="alert alert-success">'.__('You need the "<strong><em>Digital Signatures for NEX-forms</em></strong></a>" Add-on to use digital signatures! <br /><br><a href="https://1.envato.market/6vWmb" target="_blank" class="btn btn-success btn-sm">Buy Now</a>','nex-forms').'</div>';
																			$output .= '</div>';
																			}
																	break;
																	case 'input':
																	...
																	case 'icon-select-group':
																		...
																		if(!function_exists('nf_not_found_notice_ss'))
																			{
																			$output .= '<div class="'.$input_width.'  input_container">';
																					$output .= '<div class="alert alert-success">'.__('You need the "<strong><em>Super Select for NEX-forms</em></strong></a>" Add-on to use enable this field <br /><br><a href="https://1.envato.market/6vWmb" target="_blank" class="btn btn-success btn-sm">Buy Now</a>','nex-forms').'</div>';
																			$output .= '</div>';
																			}
																		else
																			{	
						...
						//HEADING
							...
							$output .= '<div class="tool-spacer"><span class="tool-section-title" title="'.__('Math','nex-forms').'" data-toggle="" data-placement="top">'.__('Math','nex-forms').'</span>';
...
$output .= '<div class="inner-form-canvas">';
	...
	$output .= '</div>';
			...
			$output .= '
			'.(($theme->Name=='NEX-Forms Demo') ? '<!--<a href="https://1.envato.market/6vWmb" target="_blank"  style="padding:7px !important;" class="btn waves-effect-nf waves-light-nf upgrade_pro animated fadeInRight">BUY NEX-FORMS</a>-->' : '' ).'
